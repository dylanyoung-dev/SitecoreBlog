...
try {
    ...
    & $mkcert -install
    & $mkcert "*.sitecoreblogtest.localhost"
}
catch {
...
Add-HostsEntry "cm.sitecoreblogtest.localhost"
Add-HostsEntry "cd.sitecoreblogtest.localhost"
Add-HostsEntry "id.sitecoreblogtest.localhost"
Add-HostsEntry "www.sitecoreblogtest.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-DockerComposeEnvFileVariable "CM_HOST" -Value "cm.sitecoreblogtest.localhost"

    # ID_HOST
    Set-DockerComposeEnvFileVariable "ID_HOST" -Value "id.sitecoreblogtest.localhost"

    # RENDERING_HOST
    Set-DockerComposeEnvFileVariable "RENDERING_HOST" -Value "www.sitecoreblogtest.localhost"
