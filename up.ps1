...
dotnet sitecore login --cm https://cm.sitecoreblogtest.localhost/ --auth https://id.sitecoreblogtest.localhost/ --allow-write true
if ($LASTEXITCODE -ne 0) {
...
Start-Process https://cm.sitecoreblogtest.localhost/sitecore/
Start-Process https://www.sitecoreblogtest.localhost/
